...
//		array.add(23, "LOW");
	...
	/**
	 * A seconda di quale plc è selezionato dal file settingsRockwell restituisco il
	...
	/**
	 * Verifico se il tag ha una scalatura o meno, leggendo da cio che è contenuto
	 * tra { e }
	 * 
	 * @param entry
	 * @return
	...
	/**
	 * Verifico se il tag è un solo in lettura (NO) o è anche in scrittura (YES)
	 * 
	 * @param entry
	 * @return
	 */

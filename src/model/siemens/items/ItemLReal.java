...
public class ItemLReal extends Item {
	...
	public String toStringExtended() {
		if (comment.equals(""))
			return "ItemLReal [value=" + value + ", name=" + name + ", address=" + address + ", simbolicName="
					+ this.getSimbolicName() + "]";
		return "ItemLReal [value=" + value + ", name=" + name + ", comment=" + comment + ", address=" + address
				+ ", simbolicName=" + this.getSimbolicName() + "]";
	}

	@Override
	public Item clone() throws CloneNotSupportedException {
		return new ItemLReal(this.getDbName(), this.getName(), this.getComment(), this.getAddress().clone(),
				this.getParent());
	}
...
//		ModelSiemens.logSiem.info("LINT this: "+this.address.gByte()+"  +  global: "+gAddr.gByte());
	...
	protected void insertItem(Item item, Row rowGen) {
		String strFormula = item.getDbName() + "_DB" + ItemStruct.intToStringFormatted(item.getAddress().getDB()) + "LREAL"
